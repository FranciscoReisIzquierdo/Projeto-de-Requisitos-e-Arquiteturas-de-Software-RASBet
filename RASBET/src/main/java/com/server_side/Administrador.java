...
public class Administrador extends Utilizador {
    Administrador(String username, String pass) {
        super(username, pass, 2);
    }

    Administrador(Administrador e) {
        super(e.getUsername(), e.getPass(), 2);
    }
    ...
    public void insert(Connection connection) throws SQLException {
        connection.prepareStatement(
                "INSERT INTO Utilizador (username,pass,modo) SELECT * FROM (SELECT '" + this.getUsername()
                        ...
                        + "' AS col2,'2') AS tmp WHERE NOT EXISTS (SELECT username FROM Utilizador WHERE username = '"
    ...
    public static Utilizador load(ResultSet resultSet1) throws SQLException {
        ...
        return new Administrador(username, pass);
    }
}
